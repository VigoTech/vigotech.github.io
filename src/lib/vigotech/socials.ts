...
const SOCIAL_ICON_MAP: Record<string, GroupLinkIcon> = {
  ...
  git: { key: 'git', icon: 'lucide:git-branch', label: 'Repositorio' },
  ...
  matrix: { key: 'matrix', icon: 'lucide:message-square', label: 'Matrix' },
  pixelfed: { key: 'pixelfed', icon: 'lucide:image', label: 'Pixelfed' },
  mobilizon: { key: 'mobilizon', icon: 'lucide:calendar', label: 'Mobilizon' },
  peertube: { key: 'peertube', icon: 'lucide:video', label: 'PeerTube' },
